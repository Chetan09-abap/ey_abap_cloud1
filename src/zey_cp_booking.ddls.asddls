...
define view entity ZEY_CP_BOOKING as select from /dmo/booking_m
composition[0..*] of ZEY_CP_BOOKSUPPL as _BookingSupplement
association to parent ZEY_CP_TRAVEL as _Travel on
