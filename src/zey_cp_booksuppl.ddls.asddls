...
define view entity ZEY_CP_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZEY_CP_BOOKING as _Booking on
   $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId
association[1..1] to ZEY_CP_TRAVEL as _Travel on
